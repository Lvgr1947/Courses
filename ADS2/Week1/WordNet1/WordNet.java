...
public class WordNet {
    ...
    private LinearProbingHashST<String, ArrayList<Integer>> nounIds;   // Hashtable for Noun - Ids 
    private LinearProbingHashST<Integer, String> idNoun;   // Hashtable for Id - Noun
    private SAP sap; // SAP class object
    private Digraph d;   // Digraph class object
